    ...
    def setup_start() -> dict:
        ...
        if initialized:
            ...
            questions = [
                ...
                "What tone should the AI use in communications? (e.g. professional, friendly, direct)",  # noqa: E501
    ...
    def setup_save_profile(fields: dict) -> dict:
        ...
        Args:
            fields: Dict of profile fields to set. Map user answers to these keys:
                ...
                vocab_rules (str): Words/phrases to avoid or prefer, e.g. "avoid: leverage".
